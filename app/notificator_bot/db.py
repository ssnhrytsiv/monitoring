...
# Використовуємо ту саму SQLite-базу, але окремий Base/engine для ізоляції
...
def _sqlite_pragmas(dbapi_conn, _):  # pragma: no cover - побічна оптимізація
    try:
    ...
    except Exception as e:  # pragma: no cover - небажано, але не критично
...
__all__ = ["Base", "SessionLocal", "db_session", "_engine"]
