...
- Generated: 2025-09-25 20:32:13 UTC
- Branch: channel_tables
...
Symbols index (functions/classes) section     104 docs/PROJECT_MAP.md ## Symbols index (functions/classes)
...
_build_full_footer._conflict_name function    114 app/flows/batch_links/process_links.py def _conflict_name(status: str) -> Optional[str]:
_build_full_footer._esc function    108 app/flows/batch_links/process_links.py def _esc(s: str) -> str:
_build_full_footer._escape unknown     105 app/flows/batch_links/process_links.py from html import escape as _escape
_build_full_footer._is_invalid_or_error function    134 app/flows/batch_links/process_links.py def _is_invalid_or_error(status: str) -> bool:
_build_full_footer._is_private function    130 app/flows/batch_links/process_links.py def _is_private(status: str) -> bool:
_build_full_footer._link_line function    141 app/flows/batch_links/process_links.py def _link_line(idx: int, url: str, title: Optional[str], status: str, tag: str = "") -> str:
_build_full_footer._strip_conflict function    121 app/flows/batch_links/process_links.py def _strip_conflict(status: str) -> str:
...
_conflict_name   function    114 app/flows/batch_links/process_links.py def _conflict_name(status: str) -> Optional[str]:
...
_esc             function    108 app/flows/batch_links/process_links.py def _esc(s: str) -> str:
...
_escape          unknown     105 app/flows/batch_links/process_links.py from html import escape as _escape
...
_extract_hidden_links_from_message function    267 app/flows/batch_links/process_links.py def _extract_hidden_links_from_message(msg) -> List[str]:
...
_invite_owner_conflict function    364 app/flows/batch_links/process_links.py def _invite_owner_conflict(invite_hash: Optional[str],
...
_is_invalid_or_error function    134 app/flows/batch_links/process_links.py def _is_invalid_or_error(status: str) -> bool:
...
_is_private      function    130 app/flows/batch_links/process_links.py def _is_private(status: str) -> bool:
...
_link_line       function    141 app/flows/batch_links/process_links.py def _link_line(idx: int, url: str, title: Optional[str], status: str, tag: str = "") -> str:
...
_main            function     34 main.py          async def _main():
...
_norm_user       function    293 app/flows/batch_links/process_links.py def _norm_user(u: Optional[str]) -> Optional[str]:
...
_owner_conflict  function    337 app/flows/batch_links/process_links.py def _owner_conflict(channel_id: Optional[int],
...
_persist_owner_conflict function    300 app/flows/batch_links/process_links.py def _persist_owner_conflict(channel_id: Optional[int],
...
_short_pause     function    260 app/flows/batch_links/process_links.py async def _short_pause():
...
_strip_conflict  function    121 app/flows/batch_links/process_links.py def _strip_conflict(status: str) -> str:
...
owner_guard_init unknown      14 main.py          from app.services.owner_conflict_guard import init as owner_guard_init
...
posts_result_init unknown      16 main.py          from app.services.posts_watch_result_db import init as posts_result_init
postwatch_init   unknown       7 main.py          from app.services.post_watch_db import init as postwatch_init
probe_channel_id function     64 app/services/joiner.py async def probe_channel_id(client, url: str):
process_links    function    395 app/flows/batch_links/process_links.py async def process_links(message, text: str, owner_display: Optional[str] = None, owner_username: Optional[str] = None):
...
setup_logging    function     30 main.py          def setup_logging():
